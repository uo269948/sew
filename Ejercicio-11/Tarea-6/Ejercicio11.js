...
class Documento{
	...
	getMapaEstaticoOseja(dondeVerlo){
        ...
        ubicacion.innerHTML = "<img src='"+this.imagenMapa+"' alt='mapa Oseja De Sajambre' id='mapa1'/>";
	}
	getMapaEstaticoPosada(lugar){
        ...
        this.imagenMapa = url + centro + zoom + tamaño + marcador + sensor + apiKey;
        ubicacion.innerHTML = "<img src='"+this.imagenMapa+"' alt='mapa Posada de Valdeon' id='mapa2'/>";
	}
	getMapaEstaticoCangas(lugar){
        ...
        this.imagenMapa = url + centro + zoom + tamaño + marcador + sensor + apiKey;
        ubicacion.innerHTML = "<img src='"+this.imagenMapa+"' alt='Cangas de Onis' id='mapa3'/>";
    }
    getMapaEstaticoTodas(lugar){
        ...
        ubicacion.innerHTML = "<img src='"+this.imagenMapa+"' alt='mapaConjunto' id='mapaTodas'/>";
    }
}
